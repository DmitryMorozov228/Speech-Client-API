...
namespace SpeechClient.Models
{
    /// <summary>
    /// The <strong>TranslatorServiceException</strong> class holds information about Exception related to <see cref="SpeechClient"/> or <see cref="SpeechClient"/>.
    /// </summary>
